...
gls.left[2] = {
    FileName = {
        provider = {function() return '  ' end, get_current_file_name},
        condition = buffer_not_empty,
...
gls.right[9] = {
    BufferType = {
        ...
        provider = {function() return ' ' end, function() return vim.bo.filetype end},
        highlight = {colors.fg, colors.section_bg},
        separator = '',
        separator_highlight = {colors.section_bg, colors.bg},
    }
...
gls.right[10] = {
    FileFormat = {
      provider = {function() return ' ' end, function() return vim.bo.fileformat end},
      -- 'FileFormat'
      highlight = {colors.fg, colors.section_bg},
      separator = ' |',
      separator_highlight = {colors.gray1, colors.section_bg},
    }
}
gls.right[11] = {
    FileEncode = {
        provider = {function() return ' ' end, function() return vim.bo.fileencoding end},
        highlight = {colors.fg, colors.section_bg},
        separator = ' |',
        separator_highlight = {colors.gray1, colors.section_bg},
    }
...
gls.right[12] = {
    PerCent = {
        ...
        separator = ' ',
        separator_highlight = {colors.gray1, colors.section_bg},
        highlight = {colors.bg, colors.gray1}
    }
}
